...
public class Activity2 extends AppCompatActivity implements MachineAdapter.PassDataToActivity {
    ...
    static
    {
        ...
        machineMap.put("Worker something", "");
        machineMap.put("d", "");
        machineMap.put("d d", "");
        machineMap.put("Wsg", "");
        machineMap.put("Werg", "");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        machineLabel = TITLE_ACTIVITY + intent.getStringExtra(MainActivity.EXTRA_TEXT);
        ...
        builder.setTitle("Confirm Data")
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (machineDataWithInput != null && machineLabel != null) {
                            openPushToDatabaseActivity(machineDataWithInput, machineLabel);
                        } else {
                            Toast.makeText(Activity2.this, "Please scan a machine barcode to continue!", Toast.LENGTH_LONG).show();
                        }
                    }
                })
